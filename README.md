  ...
  for i,v in pairs(getconnections(game:GetService("Players").localPlayer.PlayerGui.Main.ChooseTeam.Container.Pirates.Frame.ViewportFrame.TextButton.MouseButton1Click)) do -- join team
      v.Function()
  end
  ...
  spawn(function()-----anti wrong game
      if table.find(gamelist,game.PlaceId) then
          RobloxNotify("(Asus Hub","Loading..",'',2) 
      else
          RobloxNotify("Asus Hub","not this game",'',2) 
          task.wait(2)
  ...
  elseif placeId == 7449423635 then
    ...
    library:CreateWatermark("Asus Hub Script")
    local CenterHubNo1 = library:CreateWindow(os.date("Asus Hub - %A %d %B %Y"),Enum.KeyCode.RightControl)
